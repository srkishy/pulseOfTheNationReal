...
import HowToPlayAutoComplete from './components/HowToPlayAutoComplete';
    ...
    <RootSiblingParent>
      <NavigationContainer>
        <Navigator>
          ...
          <Screen name="AutoComplete" component={AutoComplete} />
          <Screen name="HowToPlay" component={HowToPlay} options={{ title: 'How to play' }} />
          <Screen name="HowToPlayAutoComplete" component={HowToPlayAutoComplete} options={{ title: 'How to play auto complete' }} />
        </Navigator>
      </NavigationContainer>
    </RootSiblingParent>
  );
